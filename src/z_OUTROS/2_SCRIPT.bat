...
set "wind=WINTP2" & set "mode=KEEP" & set "engine=node" & set "serverFile=!arg1!" & set "action=!arg2!"
...
rem PROXY E PYTHON
!3_BACKGROUND! /NOCONSOLE "!fileProjetos!\!project!\src\scripts\BAT\PROXY_PROCESS_BADGE_NOTIFICATION.bat "!project!" "!serverFile!" "!action!" "!ret!""
