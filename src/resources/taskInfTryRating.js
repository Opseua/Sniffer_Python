...
// let pathTxt, body;
// pathTxt = 'D:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Plataformas/TryRating/MES_09_SET/DIA_28/OK/00.09.01.953_GET_Categorization.txt'; // BLIND + RESP
// pathTxt = 'D:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Plataformas/TryRating/MES_10_OUT/DIA_25/OK/13.17.39.840_GET_TimeSensitiveEmailCategorizationPortugueseLanguage.txt'; // BLIND + RESP
// pathTxt = 'D:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Plataformas/TryRating/MES_09_SET/DIA_28/OK/08.12.18.436_GET_EmailCategorizationPortugueseLanguage.txt'; // NÃO
// // ***
// pathTxt = 'D:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Plataformas/TryRating/MES_08_AGO/DIA_27/OK/13.02.11.995_GET_Search20.txt'; // BLIND + RESP [1]
// pathTxt = 'D:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Plataformas/TryRating/MES_09_SET/DIA_25/OK/06.50.21.014_GET_Search20.txt'; // BLIND + RESP [2]
// pathTxt = 'D:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Plataformas/z_teste/TryRating/Search20/2-GET_TASK-respSim_###_CLOSED_DNE.txt'; // BLIND + RESP [2] CLOSED_DNE
// pathTxt = 'D:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Plataformas/TryRating/MES_09_SET/DIA_07/OK/03.08.24.366_GET_Search20.txt'; // BLIND
// pathTxt = 'D:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Plataformas/TryRating/MES_09_SET/DIA_26/OK/22.26.11.890_GET_Search20.txt'; // NÃO
// // ***
// pathTxt = 'D:/ARQUIVOS/PROJETOS/Sniffer_Python/log/Plataformas/TryRating/MES_09_SET/DIA_21/OK/12.59.14.688_GET_SearchAdsRelevance.txt'; // NÃO
// // ###
...
async function taskInfTryRating(inf = {}) {
    ...
    try {
        ...
        function keysOrder(obj, ord) { return Object.fromEntries((ord || Object.keys(obj).sort((a, b) => a.localeCompare(b))).filter(k => k in obj).concat(Object.keys(obj).filter(k => !ord?.includes(k))).map(k => [k, obj[k],])); }
                        ...
                        if (value1.isFolder && value1.path.includes('DIA_')) {
                            let retFile2 = await file({ 'action': 'list', 'path': value1.path, 'max': 500, }); if (!retFile2.ret) { return retFile2; }; for (let [index2, value2,] of retFile2.res.entries()) {
                                if (value2.isFolder && value2.path.includes('OK')) {
                                    ...
                                    for (let [index3, value3,] of retFile3.res.entries()) { if (!value3.isFolder && value3.path.includes('_GET_') && includes.every(i => value3.path.includes(i))) { arrPaths.push(value3.path); } }
