...
if "!ret!"=="FALSE" ( if "!arg1!"=="!arg1:OFF=!" ( !2_BACKGROUND! !letra!:\ARQUIVOS\WINDOWS\PORTABLE_Python\python\pythonSniffer_Python_server.exe !root!\!project!\src\python\snifferNew.py ) )
